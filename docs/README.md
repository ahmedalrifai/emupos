...
| `windows-serial.md` | Serial devices on Windows with com0com. Coming with Windows support. |
| `windows-print-queue.md` | Printing through a Windows print queue, and its one-way limit. Coming with Windows support. |
